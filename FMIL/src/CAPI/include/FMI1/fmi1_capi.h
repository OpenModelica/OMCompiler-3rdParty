 ...
 * \brief The "C" API loads and frees the FMI functions and it is through these functions all the communcation with the FMU occurs. The FMI import library wraps these functions in a more convenient way.
 *  @{
 */
