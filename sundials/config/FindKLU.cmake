...
if (KLU_LIBRARY)
	...
	if(NOT KLU_LIBRARY_DIR)
	  set(KLU_LIBRARY_DIR ${temp_KLU_LIBRARY_DIR})
	endif(NOT KLU_LIBRARY_DIR)
else (KLU_LIBRARY)
    ...
    MESSAGE("KLU INC3:")
    MESSAGE(${KLU_INCLUDE_DIR})
    MESSAGE("KLU LIB3:")
    MESSAGE(${KLU_LIBRARY_DIR})
...
MESSAGE("KLU LIBS: " ${KLU_LIBRARY} ${AMD_LIBRARY} ${COLAMD_LIBRARY} ${KLU_LIBM} ${BTF_LIBRARY} ${SUITESPARSECONFIG_LIBRARY})

set(KLU_LIBRARIES ${KLU_LIBRARY} ${AMD_LIBRARY} ${COLAMD_LIBRARY} ${KLU_LIBM} ${BTF_LIBRARY} ${SUITESPARSECONFIG_LIBRARY})
